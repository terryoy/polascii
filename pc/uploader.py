...
class PolasciiUploader:
    ...
    def patch_content(self, content):
        ...
        to_body = '<BODY BGCOLOR="#000000" TEXT="#b2b2b2" LINK="#FFFFFF">\n<center><div class="head"><span style="font-size: 56px;font-weight: bold;font-color=#aaaaaa"><a style="text-decoration: none;color: white;" href="/index.html">IMAGE FROM POLASCII</a></span></div></center>'
        from_footer = '</BODY>'
